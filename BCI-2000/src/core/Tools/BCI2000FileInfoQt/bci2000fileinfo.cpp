//////////////////////////////////////////////////////////////////////
// $Id: bci2000fileinfo.cpp 8360 2024-09-23 15:54:40Z mellinger $
...
void BCI2000FileInfo::DoOpenFile(QString filename)
{
    ...
    else if (mode == dat)
    {
        ...
        if (blockSize > 0)
        {
            ...
            ui->samples->setText(QString::number(mFile.NumSamples()));
            int duration = std::floor(mFile.NumSamples() / mFile.SamplingRate());
            ui->duration->setText(FormatTime(duration).c_str());
        }
    }
    else if (mode == prm)
    {
        ...
        ui->samples->setText(tr("N/A"));
        ui->duration->setText(tr("N/A"));
    }
