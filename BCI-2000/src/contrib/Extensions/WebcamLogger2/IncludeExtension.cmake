...
list( APPEND BCI2000_SIGSRC_FILES
   ...
   ${BCI2000_EXTENSION_DIR}/WebcamListener.h
...
if (WIN32)
   list(APPEND BCI2000_SIGSRC_FILES
      ...
      ${BCI2000_EXTENSION_DIR}/win32mf/MFVideoMediaType.cpp
      ${BCI2000_EXTENSION_DIR}/win32mf/MFAudioMediaType.cpp
   ...
   list(APPEND BCI2000_SIGSRC_LIBS
      mfplat.lib mf.lib mfreadwrite.lib mfuuid.lib strmiids.lib propsys.lib
   )
elseif (APPLE)
   list(APPEND BCI2000_SIGSRC_FILES
