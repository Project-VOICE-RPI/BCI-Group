...
// $END_BCI2000_LICENSE$
////////////////////////////////////////////////////////////////////////////////
#ifndef MF_VIDEO_MEDIA_TYPE_H
#define MF_VIDEO_MEDIA_TYPE_H

#include <mfidl.h>
#include "ComPtr.h"
#include "VideoMediaType.h"

struct MFVideoMediaType : VideoMediaType
{
  MFVideoMediaType(com::Ptr<IMFMediaType> = nullptr);
  MFVideoMediaType(const VideoMediaType&);
