...
public:
  ...
  void SetDesiredVideoMediaType(const MFVideoMediaType&);
  const MFVideoMediaType& ActualVideoMediaType() const;

  void SetDesiredAudioMediaType(const MFAudioMediaType&);
  const MFAudioMediaType& ActualAudioMediaType() const;

  void SetCameraMediaSource(com::Ptr<IMFMediaSource>, const std::string& name);
...
private:
  ...
  MFVideoMediaType mDesiredVideoMediaType, mActualVideoMediaType;
  MFAudioMediaType mDesiredAudioMediaType, mActualAudioMediaType;
