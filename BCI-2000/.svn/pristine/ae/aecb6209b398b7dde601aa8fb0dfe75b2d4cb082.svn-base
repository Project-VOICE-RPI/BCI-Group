...
MFAudioMediaType::MFAudioMediaType(com::Ptr<IMFMediaType> pType)
  : mpType(pType)
{
  if (mpType) {
    if (!IsAudio(mpType))
...
com::Ptr<IMFMediaType> MFAudioMediaType::Strip() const
{
...
bool MFAudioMediaType::IsAudio(com::Ptr<IMFMediaType> pType)
{
  GUID guid;
